...
;;module A7 where
;;Write a function, allTrue, which takes a list of boolean values and returns whether the values are all true or not.
...
;;Write a function, countIncreases, which takes a list of numbers and returns how many times the consecutive numbers increase in value.
...
;;Write a function, downSeries that takes three arguments, step, high, low all assumed to be numbers. Further, step is positive.
...
;;This function named downSeries, and this function can let list high number minus step to became a smaller number that is larger than low number. It is return the list.
;;type: list
